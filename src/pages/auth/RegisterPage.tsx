      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6">
            ...
            <div>
              <label htmlFor="password-confirm" className="block text-sm font-medium text-dark">
                Confirm Password
              </label>
              <div className="mt-1">
                <input
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="account-type" className="ml-2 block text-sm text-dark">
                I want to sell my handcrafted items
              </label>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <a
                  href="#"
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-dark hover:bg-gray-50"
                >
